...
export default function MobileMenu({ isOpen, onOpenChange, onClose }: MobileMenuProps) {
          ...
          <div className="flex items-center space-x-3">
            ...
            <div className="flex-1 min-w-0">
              <div className="text-sm font-medium text-gray-900 truncate">
                {getGreeting()}, {(userWithProfile as any)?.firstName || 'Student'}!
              </div>
              ...
              <div className="flex items-center space-x-3 mt-1">
                <div className="flex items-center space-x-1">
                  ...
                  <span className="text-xs font-medium text-amber-700">{coins}</span>
                </div>
                {streak > 0 && (
                  <div className="flex items-center space-x-1">
                    <Clock className="w-3 h-3 text-orange-500" />
                    <span className="text-xs font-medium text-orange-700">{streak}d</span>
                  </div>
                )}
              </div>
            </div>
